    ...
    <main>
        ...
        <div class="container-xl px-4 mt-4">
            <div class="row">
                <div class="col-xl-8">
                    <div class="card mb-4">
                        <div class="card-header">Form Tambah Surat Keluar</div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form
                                action="{{ Session('user')['role'] == 'admin' ? route('surat-keluar.store') : route('surat-keluar.storeStaff') }}"
                                ...
                                <button type="submit" class="btn btn-primary mt-3">Tambah Surat Keluar</button>
                            </form>
                        </div>
                    </div>
                </div>
